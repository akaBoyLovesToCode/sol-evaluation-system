...
class Message(db.Model):
    ...
    priority = db.Column(
        db.Enum("low", "normal", "high", "urgent", name="message_priority"),
        nullable=False,
        default="normal",
    )
    ...
    def create_approval_request(evaluation, recipient_id, approval_level):
        ...
        content = (
            f"Evaluation {evaluation.evaluation_number} for {evaluation.product_name} "
    ...
    def create_status_change(evaluation, recipient_id, old_status, new_status):
        ...
        content = (
            f"Evaluation {evaluation.evaluation_number} status has changed "
