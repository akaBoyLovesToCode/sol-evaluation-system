...
def get_user(user_id):
    ...
    try:
        ...
        if user_id != current_user_id and not current_user.has_permission('part_leader'):
            return create_response(
...
def update_user(user_id):
    ...
    try:
        ...
        # Check permissions
        can_edit = (
            user_id == current_user_id or  # Users can edit themselves
            current_user.has_permission('admin')  # Admins can edit anyone
        )
