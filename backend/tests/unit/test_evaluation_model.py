...
def test_evaluation_creation(session, regular_user):
    ...
    retrieved_evaluation = session.query(Evaluation).filter_by(evaluation_number='EV-20250101-001').first()
...
def test_generate_evaluation_number_with_existing_evaluations(app_context, session, regular_user):
