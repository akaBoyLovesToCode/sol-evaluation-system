...
const personalInfoRules = {
  fullName: [
    { required: true, message: t('validation.required', { field: t('profile.fullName') }), trigger: 'blur' },
    { min: 2, max: 50, message: t('validation.length', { min: 2, max: 50 }), trigger: 'blur' }
  ],
  email: [
    { required: true, message: t('validation.required', { field: t('profile.email') }), trigger: 'blur' },
...
const passwordRules = {
  currentPassword: [
    { required: true, message: t('validation.required', { field: t('profile.currentPassword') }), trigger: 'blur' }
  ],
  newPassword: [
