...
resource "aws_cloudfront_distribution" "frontend" {
  ...
  price_class         = "PriceClass_100"  # Portfolio optimization: US/Europe only

  # Portfolio optimization: simple caching behavior
...
# CodePipeline Artifacts Bucket - Block Public Access
